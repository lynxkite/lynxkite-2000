...
- An integrated collaborative code editor makes it easy to add new operations and integrate them to agentic workflows.
...
This is an entirely new generation of [LynxKite](https://github.com/lynxkite/lynxkite), purpose-built for early-stage discovery workflows.
It leverages NVIDIA GPUs and RAPIDS for accelerated linked graph analytics, with integrated GPU orchestration that enables seamless scaling across distributed GPU clusters.
