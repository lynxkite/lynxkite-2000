...
usage:
output_variable = lynxkite_graph_analytics.operations.ml_ops.train_test_split(bundle=<bundle_variable>, table_name=<table_name_value>, test_ratio=<test_ratio_value>, seed=<seed_value>)
