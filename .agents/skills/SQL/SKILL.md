...
usage:
output_variable = lynxkite_graph_analytics.src.lynxkite_graph_analytics.operations.query_ops.sql(bundle=<bundle_variable>, query=<query_value>, save_as=<save_as_value>)
