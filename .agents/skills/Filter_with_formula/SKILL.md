...
usage:
output_variable = lynxkite_graph_analytics.src.lynxkite_graph_analytics.operations.table_ops.filter_with_formula(b=<b_variable>, table_name=<table_name_value>, formula=<formula_value>)
