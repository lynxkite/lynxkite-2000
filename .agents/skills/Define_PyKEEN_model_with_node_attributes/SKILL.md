...
---
name: Define_PyKEEN_model_with_node_attributes
...
usage:
output_variable = lynxkite_graph_analytics.src.lynxkite_graph_analytics.operations.pykeen_ops.def_pykeen_with_attributes(dataset=<dataset_variable>, interaction_name=<interaction_name_value>, combination_name=<combination_name_value>, embedding_dim=<embedding_dim_value>, loss_function=<loss_function_value>, random_seed=<random_seed_value>, save_as=<save_as_value>)
