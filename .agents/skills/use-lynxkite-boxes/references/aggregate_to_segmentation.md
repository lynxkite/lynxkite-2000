...
usage:
output_variable = lynxkite_graph_analytics.operations.segmentation_ops.aggregate_to_segmentation(relation_name=<relation_name_value>, add_suffixes=<add_suffixes_value>, aggregations=<aggregations_value>, b=<b_variable>)
