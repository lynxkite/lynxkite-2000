...
usage:
output_variable = lynxkite_graph_analytics.operations.graph_ops.merge_attributes(table_name=<table_name_value>, new_attribute=<new_attribute_value>, primary_attribute=<primary_attribute_value>, secondary_attribute=<secondary_attribute_value>, b=<b_variable>)
