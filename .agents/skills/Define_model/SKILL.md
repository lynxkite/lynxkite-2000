...
usage:
output_variable = lynxkite_graph_analytics.src.lynxkite_graph_analytics.operations.ml_ops.define_model(bundle=<bundle_variable>, model_workspace=<model_workspace_value>, save_as=<save_as_value>)
