...
usage:
output_variable = lynxkite_graph_analytics.operations.pykeen_ops.full_predict(bundle=<bundle_variable>, model_name=<model_name_value>, k=<k_value>, inductive_setting=<inductive_setting_value>)
