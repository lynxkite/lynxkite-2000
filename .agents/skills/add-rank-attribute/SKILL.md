...
usage:
output_variable = lynxkite_graph_analytics.operations.table_ops.add_rank(b=<b_variable>, table_column=<table_column_value>, rank_name=<rank_name_value>, order=<order_value>)
