---
name: binned-graph-visualization
...
usage:
output_variable = lynxkite_graph_analytics.operations.visualization_ops.binned_graph_visualization(b=<b_variable>, x_property=<x_property_value>, y_property=<y_property_value>, x_bins=<x_bins_value>, y_bins=<y_bins_value>, show_loops=<show_loops_value>)
