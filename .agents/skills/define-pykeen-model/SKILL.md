...
usage:
output_variable = lynxkite_graph_analytics.operations.pykeen_ops.define_pykeen_model(bundle=<bundle_variable>, model=<model_value>, edge_data_table=<edge_data_table_value>, embedding_dim=<embedding_dim_value>, loss_function=<loss_function_value>, seed=<seed_value>, save_as=<save_as_value>)
