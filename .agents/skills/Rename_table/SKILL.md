...
usage:
output_variable = lynxkite_graph_analytics.src.lynxkite_graph_analytics.operations.table_ops.rename_table(b=<b_variable>, old_name=<old_name_value>, new_name=<new_name_value>)
