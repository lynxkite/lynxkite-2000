...
usage:
output_variable = lynxkite_graph_analytics.operations.pykeen_ops.target_predict(bundle=<bundle_variable>, model_name=<model_name_value>, head=<head_value>, relation=<relation_value>, tail=<tail_value>, inductive_setting=<inductive_setting_value>)
