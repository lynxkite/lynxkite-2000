...
---
name: Vector_from_attribute_pair
...
usage:
output_variable = lynxkite_graph_analytics.src.lynxkite_graph_analytics.operations.table_ops.vector_from_attribute_pair(b=<b_variable>, table_name=<table_name_value>, attribute1=<attribute1_value>, attribute2=<attribute2_value>, new_name=<new_name_value>)
